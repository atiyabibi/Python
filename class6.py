class onlineshpng:
    ...
    def addgst(self,gst,tax):
        print("Member function with two parameters")
    def addgift(self,gift,extracharge,gst,payment):
        print("Member function with four parameters")
...
SmartWatch.addgst(5,6)
SmartWatch.addgift(4,5,6,7)
...
Product comments are : ['not Good', 'Poor quality', 'Low battery']
